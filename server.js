...
const youtube = new YouTube("AIzaSyAZHnpb2qMCK_p832wd_24coVTqeDkTELc"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyAZHnpb2qMCK_p832wd_24coVTqeDkTELc"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@685836038807093250>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
var shuruhatik24h = {
  url: "https://sadek-sysem-bot.glitch.me",///رابط البروجكت حقك
  timeuptime: "",///سرعة الاتصال
}
...
*/
///هنا الفكشن كامل لو حذفت او عدلت هنا شيء البوت مش هيشتغل
var codebyshuruhatik =["\x75\x72\x6C","\x74\x69\x6D\x65\x75\x70\x74\x69\x6D\x65","\x31","\x6D\x69\x6E\x75\x74\x65\x73","\x75\x70","\x59\x61\x79\x21\x21\x20\x53\x65\x72\x76\x69\x63\x65\x20\x69\x73\x20\x75\x70","\x6C\x6F\x67","","","","\x6F\x6E","\x65\x72\x72\x6F\x72"];let shuruhatikuptime= new Monitor({website:shuruhatik24h[codebyshuruhatik[0]],interval:shuruhatik24h[codebyshuruhatik[1]]|| codebyshuruhatik[2],config:{intervalUnits:codebyshuruhatik[3]}});shuruhatikuptime[codebyshuruhatik[10]](codebyshuruhatik[4],function(_0x88fdx2,_0x88fdx3){console[codebyshuruhatik[6]](codebyshuruhatik[5]);console[codebyshuruhatik[6]](`${codebyshuruhatik[7]}${shuruhatik24h[codebyshuruhatik[1]]|| codebyshuruhatik[2]}${codebyshuruhatik[8]}${shuruhatik24h[codebyshuruhatik[0]]}${codebyshuruhatik[9]}`)});shuruhatikuptime[codebyshuruhatik[10]](codebyshuruhatik[11],function(_0x88fdx4,_0x88fdx2){console[codebyshuruhatik[11]](_0x88fdx4)})